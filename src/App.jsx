...
function VenueDetailRoute() {
  ...
  const loc = locations.find((location) => String(location.id) === String(id));
...
function AppContent() {
  ...
  const handleOpenVenue = (venueOrId) => {
    ...
    const venueId = typeof venueOrId === "object" ? venueOrId.id : venueOrId;
    ...
    <div className="app mt-root">
      ...
      <main className="main-content">
        <Routes>
          ...
          <Route path="/betrieb/:id" element={<VenueDetailRoute />} />
          ...
          <Route path="/gastgeber/tischform/:id" element={<TischformRoute />} />
          ...
          <Route path="/rechtliches" element={<TermsUses />} />
